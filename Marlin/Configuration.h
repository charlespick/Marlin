...
#define STRING_CONFIG_H_AUTHOR "(charlespick, SKR Creator Pro 2)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 46.77, 46.74, 201.75, 97.69 }
...
#define X_BED_SIZE 231.8
#define Y_BED_SIZE 154

// Travel limits (mm) after homing, corresponding to endstop positions.
#define X_MIN_POS -23.1
#define Y_MIN_POS 0
#define Z_MIN_POS -5
...
//#define RGBW_LED
  ...
  #define RGB_LED_G_PIN PD5
  #define RGB_LED_B_PIN PD2
